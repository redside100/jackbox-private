    ...
    class xW {
        ...
        url(t, n) {
            if (n) {
                ...
                return `${this.scheme}://${window.location.hostname}/api/v2${t}?${r}`
            }
    ...
    class E3 extends s3 {
        ...
        connect() {
            ...
            const n = i3.stringify(t),
                r = this.role === "audience" || this.id > 1e7 ? `${this.scheme}://${window.location.hostname}/api/v2/audience/${this.code}/play?${n}` : `${this.scheme}://${window.location.hostname}/api/v2/rooms/${this.code}/play?${n}`;
