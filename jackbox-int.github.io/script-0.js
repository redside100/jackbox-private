    ...
    class Dv {
        ...
        url(e, r) {
            if (r) {
                ...
                return `${this.scheme}://${window.location.hostname}/api/v2${e}?${n}`
            }
    ...
    class mg extends ig {
        ...
        connect() {
            ...
            const r = ng.stringify(e),
                n = this.role === "audience" || this.id > 1e7 ? `${this.scheme}://${window.location.hostname}/api/v2/audience/${this.code}/play?${r}` : `${this.scheme}://${window.location.hostname}/api/v2/rooms/${this.code}/play?${r}`;
    ...
    class Gg {
        constructor(e) {
            ...
            G(this, "clientProxyHandler", {
                ...
                set: (e, r, n) => r !== "conn" ? Reflect.set(e, r, n) : (this.sockets.client = n ? new tr.exports.WebSocket(`wss://${window.location.hostname}`, "ecast-v0") : null, !0)
            });
        ...
        createServer() {
            const e = new tr.exports.Server(`wss://${window.location.hostname}`);
